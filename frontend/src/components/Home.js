        ...
        <Carousel activeIndex={index} onSelect={handleSelect}>
          <Carousel.Item interval={3000}>
            ...
            <Carousel.Caption>
              <div style={{ paddingBottom: "300px" }}>
                <h1
                  style={{ display: "flex", color: "black", fontSize: "70px" }}
                >
                  GOOD NIGHT
                </h1>
                <p
                  style={{ display: "flex", color: "black", fontSize: "35px" }}
                >
                  Find your next stay
                </p>
              </div>
          ...
          "
            ...
            >
              ...
              <p>
                We have different types of rooms that contain th finest types of
...
"
            ...
            >
              ...
              <p>We have beautiful places with great views</p>
            </Carousel.Caption>
          </Carousel.Item>
        </Carousel>
      </div>
